...
@section('title')
   	Thông tin tài khoản - Clothing Store
@endsection
							...
							<div class="fieldset">
								<ul class="form-list">
                                    <li class="fields">
                                        ...
                                        <input hidden type="text" id="getID" class="input-text" value="{{$user->id}}">
										</div>
                                    </li>
									<li class="fields">
										<label for="name">Họ tên</label>
										<div class="input-box">
											<input type="text" id="getName" class="input-text" value="{{$user->name}}">
										</div>
                                    </li> 
                                    <br>
									<li class="fields">
										...
										<div class="input-box">
											<input type="text" class="input-text" value="{{$user->email}}" disabled>
										</div>
									</li>
									<br>
                                    <li class="fields">
										...
										<div class="input-box">
											<input type="text" id="getAddress" class="input-text" value="{{$user->address}}">
										</div>
                                    </li>
								</ul>
							</div>
									...
									<div class="em_nav" id="toogle_menu_5_4607">
										<ul class="vnav em-menu-icon effect-menu em-menu-long">
											<li class="menu-item-link menu-item-depth-0 fa fa-child">
												<a class="em-menu-link" href="{{ url('/my/account/'.Auth::user()->id) }}"> 
...
<script type="text/javascript">
	$('.btn-save').click(function(){
        ...
        form_data.append("user_id", $('#getID').val());
