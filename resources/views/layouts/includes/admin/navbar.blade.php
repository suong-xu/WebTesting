    ...
    <div class="navbar-brand-wrapper d-flex justify-content-center">
        ...
        >
            <a class="navbar-brand brand-logo" href="/admin/dashboard"
                style="font-weight: bold;">CLOTHING STORE</a>
                ...
                >
                    ...
                    <a class="dropdown-item">
                        <div class="item-thumbnail">
                            <img
                                src="{{
                                    asset('admin/assets/images/faces/face4.jpg')
                                }}"
                                alt="image"
                                class="profile-pic"
                            />
                    ...
                    <a class="dropdown-item">
                        <div class="item-thumbnail">
                            <img
                                src="{{
                                    asset('admin/assets/images/faces/face2.jpg')
                                }}"
                                alt="image"
                                class="profile-pic"
                            />
                    ...
                    <a class="dropdown-item">
                        <div class="item-thumbnail">
                            <img
                                src="{{
                                    asset('admin/assets/images/faces/face3.jpg')
                                }}"
                                alt="image"
                                class="profile-pic"
                            />
